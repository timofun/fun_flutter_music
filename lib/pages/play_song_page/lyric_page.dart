...
import 'package:fun_flutter_music/model/lyric.dart';
...
import 'package:fun_flutter_music/pages/play_song_page/widget_lyric.dart';
import 'package:fun_flutter_music/provider/play_song_model.dart';
import 'package:fun_flutter_music/utils/application.dart';
import 'package:fun_flutter_music/utils/lyric_utils.dart';
                ...
                child: StreamBuilder<String>(
                  ...
                  builder: (context, snapshot) {
                    if (snapshot.hasData) {
                      ...
                      // 获取当前在哪一行
                      int curLine = LyricUtils.findLyricIndex(curTime, lyrics);
                      if (!_lyricWidget.isDragging) {
