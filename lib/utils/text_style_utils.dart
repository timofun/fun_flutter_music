...
final common14TextStyle = TextStyle(fontSize: 14, color: ColorDefault);
final common13TextStyle = TextStyle(fontSize: 13, color: ColorDefault);
final bold20TextStyle = TextStyle(fontSize: 20, color: ColorDefault, fontWeight: FontWeight.bold);
final bold18TextStyle = TextStyle(fontSize: 18, color: ColorDefault, fontWeight: FontWeight.bold);
final bold14TextStyle = TextStyle(fontSize: 14, color: ColorDefault, fontWeight: FontWeight.bold);
